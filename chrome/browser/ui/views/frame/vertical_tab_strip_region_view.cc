...
VerticalTabStripRegionView::VerticalTabStripRegionView(
  ...
  // The SideTree shell is created by SetTabStripView(), after the shared base
...
views::View* VerticalTabStripRegionView::SetTabStripView(
  ...
  if (base::FeatureList::IsEnabled(features::kNativeSideTree) &&
    ...
    sidetree_shell_view_ = AddChildViewAt(
        CreateSideTreeNativeShellView(browser_view_, tab_strip_model_,
...
void VerticalTabStripRegionView::ClearTabStripView(views::View* view) {
  ...
  if (sidetree_shell_view_) {
    RemoveChildViewT(std::exchange(sidetree_shell_view_, nullptr));
  }
